(() => {
    ...
    (() => {
        ...
        function documentActions() {
            if (window.innerWidth > 767.98) document.querySelectorAll(".item-showmore__content").forEach((item => {
                item.setAttribute("data-showmore-content", 64);
            }));
            if (window.innerWidth < 767.98) document.querySelectorAll(".item-showmore__content").forEach((item => {
                item.setAttribute("data-showmore-content", 0);
            }));
            window.addEventListener("resize", (() => {
                if (window.innerWidth > 767.98) document.querySelectorAll(".item-showmore__content").forEach((item => {
                    item.setAttribute("data-showmore-content", 64);
                })); else document.querySelectorAll(".item-showmore__content").forEach((item => {
                    item.setAttribute("data-showmore-content", 0);
                }));
            }));
        }
